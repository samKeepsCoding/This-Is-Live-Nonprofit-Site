    ...
    <>
        <div className='w-full hidden  md:flex justify-center items-center mt-10 '>
            <div className='relative w-full max-w-7xl flex flex-row justify-center items-start p-10'>
                <img src={DemoImage1} alt='teamwork' className='relative top-1/2 w-[200px] md:w-[400px] -rotate-12 rounded-md'/>
                <div className='flex flex-col justify-center items-center text-start space-y-10 '>
                    ...
                    <img src={DemoImage2} alt='Ia team'  className='w-[250px] md:w-[440px] h-[150px] md:h-[300px] rotate-12 rounded-md mt-[6rem]'/>
                </div>
            </div>
        </div>
    </>
